...
/**
 * Codec for the primitive type {@link UUID}. Use {@link UUIDCodec#INSTANCE}.
 * 
 * @author notalexa
 *
 */
public class UUIDCodec implements Codec {
    ...
    @Override
    public UUID decode(not.alexa.netobjects.coding.Decoder.Buffer buffer) throws BaseException {
        return UUID.fromString(buffer.getCharContent().toString());
    }
}
